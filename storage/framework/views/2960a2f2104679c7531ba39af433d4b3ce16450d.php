                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="bg-white border-b">
                                    ...
                                    <td class="py-4 px-6">
                                        <a type="button" data-id="<?php echo e($department->id); ?>" data-name="<?php echo e($department->name); ?>" data-modal-toggle="deptModal" class="btnEditDept cursor-pointer font-medium text-blue-600 hover:underline">Edit</a>
                                        <span> | </span>
                                        <a type="submit" data-id="<?php echo e($department->id); ?>" data-name="<?php echo e($department->name); ?>" data-modal-toggle="deleteModal" class="btnDeleteDept cursor-pointer font-medium text-red-600 hover:underline">Delete</a>
                                    </td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
