        ...
        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
            <div class="relative bg-white rounded-lg shadow">
                ...
                <div class="p-6 text-center">
                    ...
                    <a href="<?php echo e(route('temp.clear')); ?>" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                        Yes, I'm sure
                    </a>
        ...
        <div style="border: 1px solid #0284c7;" class="border-sky-600 w-3/5 h-full">
            ...
            <div class="px-10 flex">
                <div class="flex justify-center items-center w-full">
                    <form id="upload_file" action="<?php echo e(route('temp.store')); ?>" method="POST" enctype="multipart/form-data" class="w-full">
                        <?php echo csrf_field(); ?>
            ...
            <div style="height: calc(100% - 140px)" class="w-full mt-1 px-10 py-2">
                <div class="w-full grid grid-cols-2">
                    ...
                    <h2 class="text-sky-600 font-medium text-right">Total Files: <span class="ml-3"><?php echo e($tempCount); ?></span></h2>
                </div>
                <div style="height: calc(100% - 30px)" class="border-2">
                    <?php if(isset($tempLast->unique_name)): ?>
                        <?php
                            $uploaded=true
                        ?>
                        <iframe src="temporary/<?php echo e($tempLast->unique_name); ?>" frameborder="0" class="w-full h-full"></iframe>
                    <?php else: ?>
                        <h1 class="text-center pt-5 text-xl text-red-500">Please upload a file.</h1>
                    <?php endif; ?>
                </div>
                <div class="pl-3">
                    <button type="button" data-modal-toggle="popup-modal" class="text-red-500 hover:text-red-600 font-semibold disabled:pointer-events-none" <?php echo e(isset($tempLast->unique_name) ? '' : 'disabled'); ?>>CLEAR</button>
                </div>
            </div>
        </div>
        <div class="pl-5 w-2/5 h-full">
            <div style="border: 1px solid #0284c7;" class="h-full">
                <form action=<?php echo e(route('upload.store')); ?> method="POST" enctype="multipart/form-data" class="w-full h-full">
                    <?php echo csrf_field(); ?>
                    <div class="p-3">
                        <label for="batch" class="text-sky-600 block mb-2 text-xl font-medium">Batch</label>
                        <select id="batch" name="batch" class="bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" <?php echo e(isset($tempLast->unique_name) ? '' : 'disabled'); ?>>
                    ...
                    <div class="p-3">
                        ...
                        <select id="docType" name="docType" class="bg-gray-50 border border-gray-300 text-gray-900 text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" <?php echo e(isset($tempLast->unique_name) ? '' : 'disabled'); ?>>
                                <option value="" style="display: none"></option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Scan-And-Encoding-System\resources\views/document-management/upload.blade.php ENDPATH**/ ?>