...
<?php $__env->startSection('content'); ?>
    ...
    <script type="text/javascript">
        ...
        $('#batch').change(function(){
            ...
            $.ajax({
                url:"<?php echo e(route('encode.getfolder')); ?>",
                method:"POST",
                data:{
                    value: value,
                    _token: _token
            ...
            $.ajax({
                url:"<?php echo e(route('encode.getfiles')); ?>",
                method:"POST",
                data:{
                    batchValue: '',
                    folderValue: '',
            ...
            $.ajax({
                url:"<?php echo e(route('encode.getform')); ?>",
                method:"POST",
                data:{
                    batchValue: '',
                    selFile: '',
        ...
        $(document).on('click', '#btnYes', function(){
            $.ajax({
                url: "<?php echo e(route('encode.store')); ?>",
                method: "POST",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Scan-And-Encoding-System\resources\views/document-management/encode.blade.php ENDPATH**/ ?>